...
import { getAuth, onAuthStateChanged, getIdToken, verifyPasswordResetCode, confirmPasswordReset, sendPasswordResetEmail, signInWithEmailAndPassword, signOut, updatePassword } from 'firebase/auth';
...
class Authenticator {
    ...
    recoveryPassword(code, password) {
        return new Promise((resolve, reject) => {
    ...
    sendRecoverPassword(email, authURL) {
        return new Promise((resolve, reject) => {
